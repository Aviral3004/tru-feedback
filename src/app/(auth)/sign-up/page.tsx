...
const SignUp = () => {
  ...
  //* calling backend api check-username-unique and passing debouncedUsername
  useEffect(() => {
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      //* For special usecase as setUsername has to be controlled as well hence field.onChange(e) is used as e is being passed
                      onChange={(e) => {
                        field.onChange(e);
